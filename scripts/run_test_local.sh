...
echo ""
 ...
 ./config/delegates_test.rb 'edepot:SA-00702-SA00632608_00001.jpg' "${EDEPOT_BASE_URL}SA/00702/SA00632608_00001.jpg"
 echo ""

echo "## edepot resolution with space in name"
 ./config/delegates_test.rb 'edepot:SA-00702 (2)-SA00632608_00001.jpg' "${EDEPOT_BASE_URL}SA/00702%20(2)/SA00632608_00001.jpg"
 echo ""
